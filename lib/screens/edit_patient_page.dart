...
class _EditPatientPageState extends State<EditPatientPage> {
  ...
  late final TextEditingController _ageController = TextEditingController(text: widget.patient.age.toString());
  ...
  void _save() {
    ...
    widget.controller
        ...
        .then((patient) => Navigator.of(context).pop(patient))
        .catchError((error) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Edit Patient (Code: ${widget.patient.patientCode})'),
        centerTitle: false,
      ),
      body: SafeArea(
        child: Form(
                    ...
                    child: Padding(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: Text(
                          ...
                          style: TextStyle(
                            color:
                                selected ? const Color(0xFF0F766E) : Colors.grey.shade800,
